...
class ConsumerCheckOut extends StatefulWidget {
  ...
  @override
  _ConsumerCheckOutState createState() => _ConsumerCheckOutState();
}

class _ConsumerCheckOutState extends State<ConsumerCheckOut> {
  String userId = "";
  String fullName = "";
  String signupType = "";
  String email = "";
  ...
  Future<void> _createOrder(String paymentId, YYDialog dialog) {
    ...
    var url =
        "https://us-central1-uwlaamart.cloudfunctions.net/httpFunction/api/v1/createOrderConsumer";
    Map data = {
