...
import 'package:uwlaa/screen/consumer_check_out.dart';
...
class ConsumerCart extends StatefulWidget {
  ...
  ConsumerCart({Key key, @required this.from}) : super(key: key);
...
class _ConsumerCartState extends State<ConsumerCart> {
  ...
  Future<void> _initCartList(YYDialog dialog) async {
    ...
    _price = 0;
    var url =
        "https://us-central1-uwlaamart.cloudfunctions.net/httpFunction/api/v1/mobileGetConsumerCart";
  ...
  Future<void> _deleteSelectedCartItem(
    ...
    var url =
        "https://us-central1-uwlaamart.cloudfunctions.net/httpFunction/api/v1/massRemoveConsumerCart";
    Map data = {
  ...
  Future<void> _updateCart(
    ...
    var url =
        "https://us-central1-uwlaamart.cloudfunctions.net/httpFunction/api/v1/mobileSingleEditForConsumerCart";
    Map data = {
      'user_id': userId,
  ...
  Future<void> _checkDefaultAddress() {
    var url =
        "https://us-central1-uwlaamart.cloudfunctions.net/httpFunction/api/v1/checkConsumerGotDefaultAddress";
    Map data = {'user_id': userId};
    var body = json.encode(data);
    _isChecking = true;
    setState(() {});
      ...
      if (resp["status"] == 'OK') {
        if (resp["result"]) {
          ...
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (BuildContext context) => ConsumerCheckOut(
