...
import 'package:uwlaa/screen/business_consumer_product_details.dart';
import 'package:uwlaa/util/ui_icons.dart';
import 'dart:io';
import 'dart:convert';

class BusinessConsumerHome extends StatefulWidget {
  BusinessConsumerHome({Key key}) : super(key: key);

  @override
  _BusinessConsumerHomeState createState() => _BusinessConsumerHomeState();
}

class _BusinessConsumerHomeState extends State<BusinessConsumerHome> {
  ...
  Future<void> _getAllProducts(YYDialog dialog) async {
    ...
    HttpClient()
        .postUrl(Uri.https(
            ...
            '/httpFunction/api/v1/mobileGetAllConsumerProducts',
            queryParameters))
